    ...
    <div class="bg-white p-4">
        ...
        <form action="pay_bills.php" method="post">
            <div class="mt-4">
                ...
                <input class="w-full p-2 border border-gray-300 rounded mt-1" placeholder="Enter 9-12 Digit Account Number" type="text" name="account_number" value="" required/>
            </div>
            <div class="mt-4">
                <label class="block text-gray-700 font-semibold">Account Name</label>
                <input class="w-full p-2 border border-gray-300 rounded mt-1" placeholder="Enter Account Name" type="text" name="account_name" value="" required/>
            </div>
            <div class="mt-4">
                <label class="block text-gray-700 font-semibold">Email Address</label>
                <input class="w-full p-2 border border-gray-300 rounded mt-1" placeholder="Enter Email Address (optional)" type="email" name="email_address" value=""/>
            </div>
